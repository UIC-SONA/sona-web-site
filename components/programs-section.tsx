...
const programs = [
  ...
  },
  {
    ...
    description: "Servicio telefónico confidencial para mujeres que necesitan orientación y apoyo inmediato en situaciones de crisis.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {programs.map(program => (
            <Card key={program.key} className="group hover:shadow-lg transition-shadow">
              <CardHeader>
